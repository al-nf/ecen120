...
adcw1	ldr		r1,[r2]						;Wait for HSI Ready
		...
		str		r1,[r2]
		ldr		r2,=(GPIOA_BASE+GPIO_MODER)		;program bits 0-1 & 2-3 in GPIOA_MODER for pin 0 & 1 analog mode (11)
		ldr		r1,[r2]
		orr		r1, #0x3						; pin 0
		orr		r1,#(0x3 << 2)					; pin 1
		str		r1,[r2]				
		ldr		r2,=(GPIOA_BASE+GPIO_ASCR)		;Enable the analog switch ASC1 & ASC0
		ldr		r1,[r2]
