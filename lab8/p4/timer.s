...
tim2_init	PROC		;initialize Timer 2 for this program and setup its interrupt
		...
		ldr		r2,=(TIM2_BASE+TIM_PSC)		;Setup the prescaler.  Assuming a 4MHz clock, this gives 0.1ms timer ticks
		ldr		r1,=399
		str		r1,[r2]
		 
		ldr		r2,=(TIM2_BASE+TIM_ARR)		;Setup the reload.  Assuming a 0.1ms tick, this gives 0.01s overflows
		ldr		r1,=699
		str		r1,[r2]
